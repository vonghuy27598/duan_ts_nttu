...
namespace AppTS.XuLy
{
    ...
    public class DHNN
    {
        ...
        public DHNN()
        {
            ...
            list_nganh = new string[] { "Y khoa (Bác sỹ Đa khoa)", "Y học dự phòng (Bác sỹ Y học dự phòng)", "Quản trị kinh doanh", "Công nghệ thông tin", "Mạng máy tính – Truyền thông dữ liệu", "Luật kinh tế", "Kỹ thuật phần mềm", "Dược học", "Điều dưỡng", "Kỹ thuật y sinh", "Vật lý y khoa", "Kỹ thuật xét nghiệm y học", "Công nghệ sinh học", "Công nghệ thực phẩm", "Công nghệ kỹ thuật hóa học", "Quản lý tài nguyên và môi trường", "Công nghệ kỹ thuật Ô-tô", "Công nghệ kỹ thuật cơ điện tử", "Công nghệ Kỹ thuật Điện – Điện tử", "Kỹ thuật Hệ thống Công nghiệp", "Kỹ thuật xây dựng", "Kiến trúc", "Thiết kế nội thất", "Kế toán", "Tài chính – Ngân hàng", "Quản trị nhân lực", "Logistics và Quản lý chuỗi cung ứng", "Marketing", "Thương mại điện tử", "Kinh doanh quốc tế", "Quan hệ quốc tế", "Tâm lý học", "Quan hệ công chúng", "Quản trị khách sạn", "Quản trị nhà hàng và dịch vụ ăn uống", "Du lịch", "Việt Nam học", "Đông phương học", "Tiếng Việt và văn hóa Việt Nam", "Ngôn ngữ Anh", "Ngôn ngữ Trung Quốc", "Truyền thông đa phương tiện", "Thiết kế đồ họa", "Thanh nhạc", "Piano", "Đạo diễn Điện ảnh – Truyền hình", "Diễn viên kịch – Điện ảnh – Truyền hình", "Quay phim" };
